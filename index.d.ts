declare namespace ContactHub {
  ...
  export type CombinedQueryConjunction = 'INTERSECT' | 'UNION' | 'EXCEPT';
...
declare class ContactHub {
  ...
  constructor(params: ContactHub.Auth)

  createSessionId(): string;

  addCustomerSession(customerId: string, sessionId: string): Promise<boolean>;

  addCustomer(customerData: ContactHub.CustomerData): Promise<ContactHub.Customer>;

  getCustomer(customerId: string): Promise<ContactHub.Customer>;

  getCustomers(options?: ContactHub.GetCustomersOptions): Promise<ContactHub.Paginated<ContactHub.Customer>>;

  updateCustomer(customerId: string, customerData: ContactHub.CustomerData): Promise<ContactHub.Customer>;

  patchCustomer(customerId: string, customerData: ContactHub.CustomerData): Promise<ContactHub.Customer>;

  deleteCustomer(customerId: string): Promise<boolean>;

  addEducation(customerId: string, education: ContactHub.Education): Promise<ContactHub.Education>;

  updateEducation(customerId: string, education: ContactHub.Education): Promise<ContactHub.Education>;

  deleteEducation(customerId: string, educationId: string): Promise<boolean>;

  addJob(customerId: string, job: ContactHub.Job): Promise<ContactHub.Job>;

  updateJob(customerId: string, job: ContactHub.Job): Promise<ContactHub.Job> ;

  deleteJob(customerId: string, jobId: string): Promise<boolean>;

  addLike(customerId: string, like: ContactHub.Like): Promise<ContactHub.Like>;

  updateLike(customerId: string, like: ContactHub.Like): Promise<ContactHub.Like>;

  deleteLike(customerId: string, likeId: string): Promise<boolean>;

  addEvent(event: ContactHub.EventData): Promise<boolean>;

  getEvent(eventId: string): Promise<ContactHub.Event>;

  getEvents(customerId: string, filters?: ContactHub.EventFilters): Promise<ContactHub.Paginated<ContactHub.Event>>;

  addTag(customerId: string, tag: string): Promise<ContactHub.Customer>;

  removeTag(customerId: string, tag: string): Promise<ContactHub.Customer>;

  createQuery(attribute: string, operator: ContactHub.AtomicConditionOperator, value?: any): ContactHub.Query;
